...
3. Generar un archivo de texto separado por comas con el reporte de las obras por estilo artistico. Debe contener el nombre de cada estilo y la cantidad de obras aseguradas de ese estilo.

4. Mostrar por pantalla la lista de todas las obras que tienen seguro por daño parcial y un monto superior al monto promedio asegurado. El listado debe presentarse ordenado en forma descendente por el año de creacion de la obra.
...
1. Cree el proyecto usando maven archetype
...
2. Cree en la carpeta _resources/META_INF_ el archivo __persistence.xml__ y pegue el siguiente contenido
...
<persistence xmlns="https://jakarta.ee/xml/ns/persistence"
    ...
    <persistence-unit name="museo" transaction-type="RESOURCE_LOCAL">
        <!-- Your entity classes -->
        <class>com.frc.isi.museo.entidades.ObraArtistica</class>
        <class>com.frc.isi.museo.entidades.Autor</class>
        <class>com.frc.isi.museo.entidades.EstiloArtistico</class>
        <class>com.frc.isi.museo.entidades.Museo</class>

        <properties>
            <!-- JDBC connection -->
            <property name="jakarta.persistence.jdbc.driver" value="org.h2.Driver" />
            <property name="jakarta.persistence.jdbc.url"
                value="jdbc:h2:file:./data/museo;AUTO_SERVER=TRUE" />
            <property name="jakarta.persistence.jdbc.user" value="sa" />
            <property name="jakarta.persistence.jdbc.password" value="" />

            <!-- Hibernate as JPA provider -->
            <property name="hibernate.dialect" value="org.hibernate.dialect.H2Dialect" />
            <property name="hibernate.hbm2ddl.auto" value="create" /> <!-- create | create-drop |
            update | validate -->
...
```
3. Cree el repositorio en GitLab sin inicializar con el README.md
